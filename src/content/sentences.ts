...
export const sentences: SentenceData[] = [
  ...
  { id: 'fi-005', difficulty: 1, sentence: 'Bilen er ___.',          correct: 'rød',     choices: ['rød', 'sulten', 'trøtt'] },
  ...
  { id: 'fi-025', difficulty: 3, sentence: 'Læreren forklarte en vanskelig ___.',  correct: 'oppgave', choices: ['oppgave', 'sykkel', 'skje'] },
  ...
  { id: 'fi-040', difficulty: 4, sentence: 'Jenta var så glad at hun måtte ___.',  correct: 'smile', choices: ['smile', 'fryse', 'nyse', 'hoste'] },
  { id: 'fi-041', difficulty: 4, sentence: 'Vi fisket hele dagen uten å få ___.',  correct: 'noe',  choices: ['noe', 'alt', 'ingenting', 'mer'] },
  { id: 'fi-042', difficulty: 4, sentence: 'Helikopteret landet ___ gården.',  correct: 'ved', choices: ['ved', 'over', 'under', 'bak'] },
  ...
  { id: 'fi-053', difficulty: 5, sentence: 'Neshornet har et stort horn på ___.',  correct: 'nesen', choices: ['nesen', 'halen', 'ryggen', 'foten'] },
  ...
  // ── Difficulty 6 ───────────────────────────────────────────────
  { id: 'fi-056', difficulty: 6, sentence: 'Flodhesten tilbringer mye tid i ___.',  correct: 'vannet', choices: ['vannet', 'treet', 'skapet', 'huset'] },
  ...
  { id: 'fi-069', difficulty: 7, sentence: 'Jordskjelv måles på en ___ kalt Richterskalaen.',  correct: 'skala', choices: ['skala', 'linje', 'farge', 'form'] },
  ...
  { id: 'fi-075', difficulty: 7, sentence: 'Kragebenet ligger mellom skulderen og ___.',  correct: 'brystbenet', choices: ['brystbenet', 'låret', 'albuen', 'kneet'] },
  ...
  // ── Difficulty 8 ───────────────────────────────────────────────
  { id: 'fi-078', difficulty: 8, sentence: 'Ribbena beskytter de indre ___ i brystkassen.',  correct: 'organene', choices: ['organene', 'musklene', 'knoklene', 'nervene'] },
  { id: 'fi-079', difficulty: 8, sentence: 'Trompeten er et blåseinstrument laget av ___.',  correct: 'messing', choices: ['messing', 'diamant', 'kull', 'gummi'] },
  { id: 'fi-080', difficulty: 8, sentence: 'Ørnen er kjent for sine skarpe ___.',  correct: 'klør', choices: ['klør', 'fjær', 'vinger', 'fingre'] },
  { id: 'fi-081', difficulty: 8, sentence: 'Jordskjelv oppstår langs tektoniske ___.',  correct: 'plategrenser', choices: ['plategrenser', 'elvebredder', 'kystlinjer', 'fjellkjeder'] },
  ...
  { id: 'fi-083', difficulty: 8, sentence: 'Xylofonen lages av treplanker lagt over ___.',  correct: 'resonanskasser', choices: ['resonanskasser', 'strenger', 'membraner', 'ventiler'] },
  { id: 'fi-084', difficulty: 8, sentence: 'Stafettløp krever god ___ mellom deltakerne.',  correct: 'koordinasjon', choices: ['koordinasjon', 'styrke', 'høyde', 'balanse'] },
  { id: 'fi-085', difficulty: 8, sentence: 'Snowboard kom fra USA og ble raskt ___ i hele verden.',  correct: 'populært', choices: ['populært', 'forbudt', 'glemt', 'ulovlig'] },
  ...
  { id: 'fi-091', difficulty: 9, sentence: 'Wifi sender ___ signaler gjennom lufta.',  correct: 'trådløse', choices: ['trådløse', 'kablede', 'skriftlige', 'malte'] },
  ...
  { id: 'fi-093', difficulty: 9, sentence: 'Luftputefartøyet svever like over bakken og kan kjøre både på vann og på ___.',  correct: 'land', choices: ['land', 'månen', 'skinner', 'skyer'] },
  { id: 'fi-094', difficulty: 9, sentence: 'Triatlon er en OL-øvelse der man gjør ___ øvelser.',  correct: 'tre', choices: ['tre', 'to', 'fire', 'fem'] },
  { id: 'fi-095', difficulty: 9, sentence: 'Svart er fravær av ___.',  correct: 'lys', choices: ['lys', 'skygge', 'mørke', 'natt'] },

  // ── Difficulty 10 ──────────────────────────────────────────────
  { id: 'fi-096', difficulty: 10, sentence: 'Mellomgulvet trekker seg sammen og ___ når vi puster inn.',  correct: 'flater ut', choices: ['flater ut', 'hever seg', 'krymper', 'stivner'] },
  ...
  { id: 'fi-098', difficulty: 10, sentence: 'Slagverket i et orkester bidrar med dynamikk og ___.',  correct: 'rytme', choices: ['rytme', 'melodi', 'harmoni', 'tekstur'] },
  ...
  { id: 'fi-100', difficulty: 10, sentence: 'Lerretet i kinosalen reflekterer lyset fra ___.',  correct: 'projektoren', choices: ['projektoren', 'lampen', 'komfyren', 'veggene'] },
]
