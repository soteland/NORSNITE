...
const MESSAGES = {
  perfect: [
    ...
    { headline: '🎯 Bullseye!', sub: 'Hundred prosent! Odin ville vært stolt.' },
    { headline: '🔥 Er det mulig?', sub: 'Du brilljerer, viking!' },
    { headline: '💫 Strålende!', sub: 'Perfekt gjennomkjøring — prøv neste nivå!' },
  ...
  zero: [
    ...
    { headline: '🔄 Prøv igjen!', sub: 'Alle gjør feil — det er slik vi lærer!' },
